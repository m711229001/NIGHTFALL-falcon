...
icons_dir = Path(r"C:\BugBounty\NIGHTFALL\web\frontend\src\v2\components")
...
(icons_dir / "Icons.jsx").write_text(icons_content, encoding="utf-8")
print("[OK] Icons.jsx created")
print("     Path:", icons_dir / "Icons.jsx")
print("     Icons count:", icons_content.count('":'))
